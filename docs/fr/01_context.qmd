...
Using generalized synthetic control methods [@Xu2017] with an extended donor pool of up to nine additional observatories, we estimate the average treatment effect on the treated (ATT) for equivalised household income. We complement each inter-observatory gsynth estimate with a within-observatory household-level difference-in-differences (DiD) check — a Callaway–Sant'Anna design [@CallawayS2021] that exploits exposure-intensity contrasts inside the observatory — providing a second, independent identification robust to regional economic trends that could confound the inter-observatory comparison. We then extend the analysis to three additional observatory–PA pairs (Farafangana, Toliara North, Fénérive East) where PAs were created in 2006–2007, exploiting the staggered timing to strengthen identification.
