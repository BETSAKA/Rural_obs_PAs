...
| $\infty$ | Marovoay ouest (2) + 6 donneurs propres | Jamais exposés | Contrôles |
...
Le DiD CS inter-observatoires présenté dans l'[Annexe C](A3_robustness.qmd) implémente déjà l'estimation Callaway–Sant'Anna à traitement échelonné au niveau des ménages avec `panel = FALSE`, regroupant les cohortes Marovoay (g = 2003) et Alaotra (g = 2008) face aux six observatoires donneurs propres. Les résultats confirment le schéma qualitatif de gsynth : un ATT négatif pour la cohorte Marovoay et un ATT nul pour la cohorte Alaotra.

Lorsque la vague d'enquête 2026 sera disponible, l'estimateur pourra être étendu avec une cinquième cohorte (Fénérive Est, une fois ses résultats post-traitement observés). Un estimateur Sun–Abraham [-@SunAbraham2021] pondéré par l'interaction via `fixest::sunab()` peut fournir un résumé d'étude d'événements transparent aux côtés de l'estimateur CS. Si gsynth et DiD groupé convergent sur l'ensemble élargi de sites, les preuves sont plus crédibles indépendamment de l'hypothèse d'identification préférée. Si la vague 2026 couvre Fénérive Est, la petite empreinte de la Réserve de Tampolo permet un dispositif de distance intra-observatoire contrastant les sites proches et éloignés de l'AP, ajoutant un troisième contexte géographique indépendant aux côtés de Marovoay et Alaotra.

Les résultats gsynth actuels doivent être lus comme une première analyse qui bénéficiera d'une estimation au niveau des ménages exploitant toute la profondeur des données lorsque la couverture des enquêtes s'élargira.
