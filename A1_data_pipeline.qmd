...
ggplot() +
  ...
  labs(title = "Georeferenced ROS Survey Locations",
...
ggplot() +
  ...
  scale_fill_brewer(palette = "Paired", guide = "none") +
  labs(title = "ROS Survey Communes and Protected Area Boundaries",
...
tribble(
  ...
  tab_style(
    ...
    locations = cells_body(
      rows = Component %in% c("Current income", "Total income", "OECD-equiv. income")
    )
  )
```
