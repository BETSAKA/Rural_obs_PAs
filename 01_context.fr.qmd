...
En utilisant les méthodes de contrôle synthétique généralisé [@Xu2017] avec un pool de donneurs élargi comprenant jusqu'à neuf observatoires supplémentaires, nous estimons l'effet moyen du traitement sur les traités (ATT) pour le revenu équivalisé des ménages. Nous étendons ensuite l'analyse à trois paires observatoire–aire protégée supplémentaires (Farafangana, Toliara Nord, Fénérive Est) où des aires protégées ont été créées en 2006–2007, exploitant le calendrier échelonné pour renforcer l'identification.
