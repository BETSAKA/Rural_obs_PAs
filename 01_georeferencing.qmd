...
> Ici on reproduit juste pour information l'algorithme qu'on a utilisé pour géoréférencer les données OR 1995-2015 par commune et Fokontany. Cette page provient de [Madagascar rural observatory system data validation, preparation, and georeferencing](https://betsaka.github.io/Rural_obs_Madagascar/03-ros-data-georeferencing.html). Ceci au cas où on trouverait des géoréférencements erronés ou manquants.
