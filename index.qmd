...
author:
  - name: Florent Bédécarrats
    affiliations:
      - UMI SOURCE (IRD / UVSQ)
  - name: Véromanitra Razafimahenina
    affiliations:
...
— a technique that constructs data-driven counterfactuals for each treated
unit by modelling unobserved common factors — we compare two governance
archetypes:

- **Strict conservation** (IUCN category II): the 2002 extension of
  Ankarafantsika National Park, monitored via the Marovoay observatory.
...
We find a persistent negative effect of strict conservation at Ankarafantsika on
equivalised household income (ATT ≈ {{< var att_maro >}} log points), while
multipurpose conservation at Alaotra shows no detectable effect (ATT ≈
{{< var att_ala >}} log points).
