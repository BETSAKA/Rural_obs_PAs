...
subtitle: "Long-Run Evidence from Rural Observatory Surveys (1995–2025)"
---
...
surrounding communities? We exploit the staggered creation and reclassification
of protected areas in Madagascar between 2002 and 2008, combined with two
decades of household survey data from the Rural Observatory Surveys (ROS,
1995–2015) and a 2025 resurvey, to estimate causal impacts on household income.

Using generalized synthetic control methods with interactive fixed effects, we
compare two governance archetypes:

- **Strict conservation** (IUCN category II): the 2002 reclassification of
  Ankarafantsika as a national park, monitored via the Marovoay observatory.
- **Multipurpose conservation** (IUCN category VI): the 2008 creation of the
  Lac Alaotra new protected area, monitored via the Alaotra observatory.

We find a persistent negative effect of strict conservation on equivalised
household income (ATT ≈ {{< var att_maro >}} log points), while multipurpose
conservation shows no detectable effect (ATT ≈ {{< var att_ala >}} log points).
These results extend to three additional observatory–PA pairs. A 2025 resurvey
confirms the long-run persistence of these patterns.

## Structure

The paper chapters present the core argument:
...
3. [**Identification Strategy**](03_strategy.qmd) — Treatment definitions,
